...
df = df[['Department: ','Position Title:','POSITION SUMMARY:','responsabilities','EI','familypos','TS']]
...
model.build_vofamilyposb(tagged_data)
...
#tsne_results = tsne.fit_transform(familypos_data)
