...
print(fils)
all_dfs = convertor.html_to_df(fils)
#all_dfs = concat(all_dfs).reset_index().drop('index', axis = 1)
print(all_dfs.info())
#all_dfs.to_csv('Process and Occupational Safety.csv', sep = ';', encoding = 'utf-8')
